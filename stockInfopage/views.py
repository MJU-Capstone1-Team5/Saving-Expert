...
def detail(request,code):
    ...
    # date=datetime.now()
    datenow1 = datetime.datetime.today() -datetime.timedelta(days=29)
    datenow2 = datetime.datetime.today() -datetime.timedelta(days=5)
    datenow3 = datetime.datetime.today() -datetime.timedelta(days=12)
    datenow4 = datetime.datetime.today() -datetime.timedelta(days=19)
